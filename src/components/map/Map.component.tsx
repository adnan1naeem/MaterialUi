 ...
 * @param {func} props.onDragEnd Callback that is called when the Mark pointer changes.
...
const MapComponent:React.StatelessComponent<ILocation & IGoogleMaps> = (props) =>(
        <Gmaps
