...
test('Avatar component with size props', () => {
    const avatar = react_test_renderer_1.default.create(React.createElement(__1.Avatar, { size: 100 })).toJSON();
...
test('Avatar component with style', () => {
    const avatar = react_test_renderer_1.default.create(React.createElement(__1.Avatar, { style: { backgroundColor: 'green' } })).toJSON();
...
test('Avatar component with src props', () => {
    const avatar = react_test_renderer_1.default.create(React.createElement(__1.Avatar, { src: "https://material-ui-next.com/static/images/remy.jpg" })).toJSON();
...
test('Avatar component with src and size props', () => {
    const avatar = react_test_renderer_1.default.create(React.createElement(__1.Avatar, { src: "https://material-ui-next.com/static/images/remy.jpg", size: 200 })).toJSON();
...
test('Avatar component with children props', () => {
    const avatar = react_test_renderer_1.default.create(React.createElement(__1.Avatar, { size: 200 }, "hello")).toJSON();
