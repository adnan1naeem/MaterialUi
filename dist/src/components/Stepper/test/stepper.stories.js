...
stories.add('Stepper progresss', () => {
    return (React.createElement(Stepper_components_1.Stepper, { variant: "progress", activeStep: 3, backButton: backButton, nextButton: NextButton, steps: 6 }));
});
stories.add('Stepper dot', () => {
    return (React.createElement(Stepper_components_1.Stepper, { variant: "dots", activestep: 3, backButton: backButton, nextButton: NextButton, steps: 6 }));
});
