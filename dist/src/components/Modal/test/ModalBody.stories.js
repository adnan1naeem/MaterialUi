...
const stories = react_1.storiesOf('ModalBody', module);
...
stories.add('ModalBody  styling', () => {
    return (React.createElement(ModalBody_Component_1.default, { style: { color: 'red' } }, "Let Google help apps determine location. This means sending anonymous location data to Google, even when no apps are running."));
});
