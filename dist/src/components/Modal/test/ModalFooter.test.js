...
test('ModalFooter has prop maxWidth', () => {
    const notification = enzyme_1.shallow(react_1.default.createElement(_1.ModalFooter, null, "\"footer\""));
    expect(notification.props().children).toBeDefined();
});
test('ModalFooter has prop fullScreen', () => {
    const notification = enzyme_1.shallow(react_1.default.createElement(_1.ModalFooter, { fullScreen: true }));
