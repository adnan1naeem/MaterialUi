...
test('ModalHeader has prop maxWidth', () => {
    const notification = enzyme_1.shallow(react_1.default.createElement(_1.ModalHeader, null, "\"footer\""));
    expect(notification.props().children).toBeDefined();
});
test('ModalHeader has prop style', () => {
    const notification = enzyme_1.shallow(react_1.default.createElement(_1.ModalHeader, { style: { color: 'green' } }));
