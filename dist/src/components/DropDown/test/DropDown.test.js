...
test('it should show normal dropDown', () => {
    const DropdownList = enzyme_1.shallow(react_1.default.createElement(_1.Dropdown, { value: 'jsbha' }));
    expect(DropdownList.props().value).toEqual('jsbha');
});
test('it should show dropdown with autoWidth true', () => {
    const DropdownList = enzyme_1.shallow(react_1.default.createElement(_1.Dropdown, { autoWidth: true }));
    expect(DropdownList.props().autoWidth).toEqual(true);
});
test('it should  disable dropdown with true prop', () => {
    const DropdownList = enzyme_1.shallow(react_1.default.createElement(_1.Dropdown, { disabled: true }));
...
test('it should add multiple items with this props', () => {
    const DropdownList = enzyme_1.shallow(react_1.default.createElement(_1.Dropdown, { multiple: true }));
