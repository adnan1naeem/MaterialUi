...
test('ListItem  with children props', () => {
    const listitem = react_test_renderer_1.default.create(react_1.default.createElement(__1.ListItem, null, "Hello")).toJSON();
...
test('ListItem with primary props', () => {
    const listitem = react_test_renderer_1.default.create(react_1.default.createElement(__1.ListItem, { primary: "hello" }, "Hello")).toJSON();
    expect(listitem.props.primary).toEqual('hello');
    expect(listitem).toMatchSnapshot();
});
test('ListItem with secondary props', () => {
    const listitem = react_test_renderer_1.default.create(react_1.default.createElement(__1.ListItem, { secondary: "Hi" }, "Hello")).toJSON();
