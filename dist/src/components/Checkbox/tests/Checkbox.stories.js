...
react_1.storiesOf('Checkbox', module).addDecorator(addon_knobs_1.withKnobs).add('label disabled value props with knobs', () => React.createElement(Checkbox_1.default, { color: "primary", disabled: addon_knobs_1.boolean('Disable', false), onChange: () => addon_actions_1.action('i was presse') }));
react_1.storiesOf('Checkbox', module).add('with onPress', () => React.createElement(Checkbox_1.default, { color: "secondary", onPress: addon_actions_1.action('check changed') }));
...
react_1.storiesOf('Checkbox', module).add('Custom icon and checkedicon', () => React.createElement(Checkbox_1.default, { icon: React.createElement(FavoriteBorder_1.default, null), checkedIcon: React.createElement(Favorite_1.default, null), testID: "checkedH", label: "Custom icon" }));
react_1.storiesOf('Checkbox', module).add('Custom icon and checkedIcon with size', () => React.createElement(Checkbox_1.default, { icon: React.createElement(CheckBoxOutlineBlank_1.default, { fontSize: "small" }), checkedIcon: React.createElement(CheckBox_1.default, { fontSize: "small" }), testID: "checkedI", label: "Custom size" }));
