...
react_1.storiesOf('Checkbox', module).add('with onPress', () => React.createElement(Checkbox_1.default, { label: "with onPress", color: "contrast", value: true, onChange: () => addon_actions_1.action('i was presse') }));
