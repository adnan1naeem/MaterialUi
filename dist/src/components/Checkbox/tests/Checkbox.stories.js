...
react_1.storiesOf('Checkbox', module).add('with onPress', () => React.createElement(Checkbox_1.default, { label: "with onPress", color: "contrast", onPress: addon_actions_1.action('check changed') }));
