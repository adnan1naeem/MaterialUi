...
react_1.storiesOf('TextInput', module).add('with placeholder, default value, onChange, autoComplete, autoFocus', () => React.createElement(TextInput_1.TextInput, { placeholder: "hello", defaultValue: "nooo", onChange: handleTextInputChange, autoComplete: "Hello World !!", autoFocus: true }));
...
react_1.storiesOf('TextInput', module).add('with type password', () => React.createElement(TextInput_1.TextInput, { id: "password", label: "Password", className: textFieldClasses, type: "password", autoComplete: "current-password", margin: "normal" }));
