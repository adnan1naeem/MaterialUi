...
react_1.storiesOf('TextInput', module).add('with type date', () => React.createElement(TextInput_1.TextInput, { id: "multiline-flexible", style: labelProps, type: "date", editable: true, label: "Full Width", placeholder: "Placeholder", onChange: handleTextInputChange, className: textFieldClasses, margin: "normal" }));
